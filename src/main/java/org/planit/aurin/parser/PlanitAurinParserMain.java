 ...
 * <li> --output "./output" output directory, if absent defaults to directory this application was invoked from<li>
 * </ul>
 * </p>
 * 
 * 
...
public class PlanitAurinParserMain {
   ...
   * @param keyValueMap arguments containing configuration choices
   */
  private static void configureNetworkWriter(PlanitMatsimNetworkWriter matsimNetworkWriter, Map<String, String> keyValueMap) {
